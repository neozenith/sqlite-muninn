...
Benchmarked on Apple M1 (ARM64, NEON SIMD):

**HNSW (dim=64, M=16, ef_c=100, ef_s=64):**

| N | Insert Rate | Search Latency | Recall@10 |
|---|------------|----------------|-----------|
| 1,000 | 526 vec/s | 0.20 ms | 100% |
| 5,000 | 394 vec/s | 0.46 ms | 99.7% |
| 10,000 | 346 vec/s | 0.54 ms | 99.1% |

**Graph TVFs (5,000 nodes, 15,000 edges):**

| Algorithm | Time |
|-----------|------|
| Connected Components | 132 ms |
| PageRank (20 iter) | 152 ms |

Run benchmarks: `python python/benchmark.py`
