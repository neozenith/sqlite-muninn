...
class TestPermutationId:
    def test_gutenberg_permutation_id(self):
        t = KGNerExtractionTreatment("gliner_small-v2.1", "gutenberg:3300")
        assert t.permutation_id == "kg-extract_gliner_small-v2.1_gutenberg-3300"

    def test_crossner_permutation_id(self):
        t = KGNerExtractionTreatment("gliner_small-v2.1", "crossner_conll2003")
        assert t.permutation_id == "kg-extract_gliner_small-v2.1_crossner_conll2003"
...
class TestNerDatasetWithGold:
    def test_spacy_produces_f1_with_gold_labels(self, tmp_path):
        ...
        t = KGNerExtractionTreatment("spacy_en_core_web_lg", "test_ds")
    ...
    def test_no_f1_for_gutenberg(self, tmp_path):
        """Gutenberg source has no gold labels, so F1 fields should be absent."""
        t = KGNerExtractionTreatment("spacy_en_core_web_lg", "gutenberg:99999")
        conn = sqlite3.connect(":memory:")
        t.setup(conn, tmp_path / "db.sqlite")
